...
const char* BIP71_MIMETYPE_PAYMENT = "application/zzcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/zzcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/zzcoin-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start zzcoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("zzcoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'zzcoin://' is not a valid URI. Use 'zzcoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid zzCoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
