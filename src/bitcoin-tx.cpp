...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " zzcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  zzcoin-tx [options] <hex-tx> [commands]  Update hex-encoded zzcoin transaction\n" +
            "or:     zzcoin-tx [options] -create [commands]   Create hex-encoded zzcoin transaction\n" +
            "\n";
