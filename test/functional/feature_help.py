...
"""Verify that starting zzcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zzcoin with -h for help text")
        ...
        self.log.info("Start zzcoin with -version for version information")
        ...
        self.log.info("Start zzcoind with -fakearg to make sure it does not start")
