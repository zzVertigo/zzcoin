# Support for Output Descriptors in zzCoin Core

Since zzCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `zzc1...` for mainnet or `tzzc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on zzCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing zzCoin Core wallets, a convenience function `combo` is
