...
bech32_templates = [
  ...
  ('zzc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('zzc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('zzc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tzzc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tzzc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tzzc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rzzc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rzzc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rzzc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tzzc',  17, 32, False, False, False),
  ('rzzc',  3,  1, False, False, False),
  ('zzc',   15, 41, False, False, False),
  ('tzzc',  0, 16, False, False, False),
  ('rzzc',  0, 32, True,  False, False),
  ('zzc',   0, 16, True,  False, False),
  ('tzzc',  0, 32, False, True,  False),
  ('rzzc',  0, 20, False, False, True)
]
